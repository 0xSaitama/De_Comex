...
contract ExecuteVoteConsumer is Test {
    ...
    bytes32 requestId = bytes32(0x1cb9a1e7e5f6a3fc89d16d0486c98ae3b387274cbd55dc4c80fee5f2c73ed9db);
    ...
    function run() public {
        ...
        VoteConsumer.Transaction[] memory transactions = new VoteConsumer.Transaction[](1);
         transactions[0] = VoteConsumer.Transaction({
            target: address(0x36053e79F719C3a09A4D84d11A273aA3B4874d04),
            data: data,
            value: 0
        });
        voteConsumer.executeTransactionBatch(requestId, transactions);
